...
namespace vue
{
    public partial class livrees : Form
    {
        List<colis> cls = new List<colis>();
        private List<colis> ll;
        public int c;
        public livrees(int codeexp)
        {
            InitializeComponent();
            c = codeexp;
            loaddata();
        ...
        public void loaddata()
        {
            ...
            {
                MessageBox.Show("vous n' avez pas aucun cols livree");
            }


        }

        private void livrees_Load(object sender, EventArgs e)
        {
