...
namespace vue
{
    public partial class audepot : Form
    {
        List<colis> cls = new List<colis>();
        private List<colis> ll;
        public int c;
        public audepot(int codeexp)
        {
            InitializeComponent();
            c = codeexp;
            loaddata();
        ...
        public void loaddata()
        {
            ...
            {
                MessageBox.Show("vous n' avez pas aucun cols Au depot");
            }
        }

        private void audepot_Load(object sender, EventArgs e)
        {
